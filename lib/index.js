...
class Client {
  ...
  * @param {Object} opts.sys - entry metadata object
  * @param {String} opts.sys.contentType.sys.id - entry content type id value
  ...
  */
   ...
   * @param {Object} opts - options for entry based on contentful Entry object
   * @param {Object} opts.sys - entry metadata object
   * @param {String} opts.sys.id - entry id
   * @param {Object} opts.fields - entry fields object
   * @returns {Promise} promise for newly created entry
   */
  updateEntry (opts) {
